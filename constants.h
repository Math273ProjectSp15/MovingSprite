...
const char SHIP_IMAGE[] = "pictures\\RedHeadBoy.png";   // spaceship
...
const int  SHIP_END_FRAME = 5;              // last frame of ship animation
const float SHIP_ANIMATION_DELAY = 0.05f;    // time between frames of ship animation
const int  SHIP_COLS = 6;                   // ship texture has 2 columns
const int  SHIP_WIDTH = 98;                 // width of ship image
const int  SHIP_HEIGHT = 162;                // height of ship image
const float ROTATION_RATE = 180.0f;         // degrees per second
const float SCALE_RATE = 0.2f;              // % change per second
const float SHIP_SPEED = 400.0f;            // pixels per second
